...
static const _AimInfo_type_support_symbol_names_t _AimInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aim_interfaces, msg, AimInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aim_interfaces, msg, AimInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aim_interfaces, msg, AimInfo)() {
  return &::aim_interfaces::msg::rosidl_typesupport_c::AimInfo_message_type_support_handle;
}
